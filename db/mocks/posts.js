...
},
{
	...
	"comments" : [
		{
			"author" : "depression",
			"cid" : ObjectId("51d1e3c7ecad047f54000001"),
			"email" : "fakeprofile69@hotmail.com",
			"flags" : [
				"pundit"
			],
			"ip" : "75.172.138.160",
			"rate_down" : 11,
			"rate_up" : 10,
			"raters" : DBRef("blog.comments.raters", ObjectId("51d1e3c7ecad047f54000000")),
			"replies" : [
				{
					"cid" : ObjectId("51d1e4abecad046c5400000c"),
					"author" : "mrfurgeddaboutit",
					"email" : "velocitor@comcast.net",
					"flags" : [ ],
					"ip" : "214.1.231.249",
					"rate_down" : 7,
					"rate_up" : 13,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d1e4abecad046c5400000b")),
					"reply" : ObjectId("51d1e3c7ecad047f54000001"),
					"reply_author" : "depression",
					"text" : "Why the hate? There wasn't anything going on, on that field anyhow, besides a baseball game.",
					"ts" : ISODate("2013-07-01T20:20:59.204Z"),
					"session_id" : ObjectId("511e62cbecad04985600000e")
				},
				{
					"cid" : ObjectId("51d1ec0069bedd425f000010"),
					"author" : "depression",
					"email" : "fakeprofile69@hotmail.com",
					"flags" : [
						"pundit"
					...
					"rate_down" : 7,
					"rate_up" : 3,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d1ec0069bedd425f00000f")),
					"reply" : ObjectId("51d1e4abecad046c5400000c"),
					"reply_author" : "mrfurgeddaboutit",
					"text" : "if we don't double the fine we will then have two tiers of justice .......\n\nThe rich who will be able to disregard the laws at a whim because they can easily afford the pentalites ,and then the poor ....\n\nShe should be punished more harshly because she only made the decision to rush the field after she knew there would be no consequences for her ...",
					"ts" : ISODate("2013-07-01T20:52:16.712Z"),
					"url" : "",
					"user_id" : ObjectId("50bce0acecad04031500000d"),
					"session_id" : ObjectId("50bce0acecad04031500000d")
				},
				{
					"cid" : ObjectId("51d1f37069bedd3e78000009"),
					"author" : "biff",
					"email" : "spladow96@yahoo.com",
					"flags" : [
						"pundit"
					],
					"ip" : "216.52.207.121",
					"rate_down" : 0,
					"rate_up" : 9,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d1f37069bedd3e78000008")),
					"reply" : ObjectId("51d1ec0069bedd425f000010"),
					"reply_author" : "depression",
					"text" : "Civil penalties are meant to be a deterrent from action; they are not absolute. People have ALWAYS have the option of breaking rules and paying the penalty. That's why you don't get double fines for speeding even though you know you are speeding. Her action in running onto the field was the social equivalent of speeding. She knew it was wrong, but did it anyway and was ready to take her punishment.",
					"ts" : ISODate("2013-07-01T21:24:00.268Z"),
					"url" : "",
					"user_id" : ObjectId("51a7cb96eab8ea5741000003"),
					"session_id" : ObjectId("51a7cb96eab8ea5741000003")
				},
				{
					"cid" : ObjectId("51d1f883ecad04597700000c"),
					"author" : "cmonster",
					"email" : "cmonster67@gmail.com",
					"flags" : [
						"pundit"
					],
					"ip" : "66.41.51.191",
					"rate_down" : 2,
					"rate_up" : 5,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d1f883ecad04597700000b")),
					"reply" : ObjectId("51d1ec0069bedd425f000010"),
					"reply_author" : "depression",
					"text" : "Makes sense. Add to the fine community service, make them clean the bathrooms after a couple of games.",
					"ts" : ISODate("2013-07-01T21:45:39.157Z"),
					"url" : "",
					"user_id" : ObjectId("4ed282e769bedda74000000d"),
					"session_id" : ObjectId("4ed282e769bedda74000000d")
				},
				{
					"cid" : ObjectId("51d2103f69bedd5a31000009"),
					"author" : "W.R.Printz",
					"email" : "wprintz@l2soft.com",
					"flags" : [ ],
					"ip" : "74.95.13.153",
					"rate_down" : 1,
					"rate_up" : 2,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d2103f69bedd5a31000008")),
					"reply" : ObjectId("51d1f883ecad04597700000c"),
					"reply_author" : "cmonster",
					"text" : "Clean the bathrooms at a game? What kind of monster are you?\n\nOh....I C now.....",
					"ts" : ISODate("2013-07-01T23:26:55.285Z"),
					"session_id" : ObjectId("51240df3eab8eab23a000012")
				}
			],
			"session_id" : ObjectId("50bce0acecad04031500000d"),
			"text" : "double the fine .......",
			"ts" : ISODate("2013-07-01T20:17:11.918Z"),
			"url" : "",
			"user_id" : ObjectId("50bce0acecad04031500000d")
		},
		{
			"cid" : ObjectId("51d1e88decad041e5b000024"),
			"author" : "jt",
			"email" : "qzv007@yahoo.com",
			"flags" : [ ],
			"ip" : "208.120.209.205",
			"rate_down" : 2,
			"rate_up" : 17,
			"raters" : DBRef("blog.comments.raters", ObjectId("51d1e88decad041e5b000023")),
			"text" : "She probably caught plenty of balls to the chin later that night...This chicks seems like a good time..",
			"ts" : ISODate("2013-07-01T20:37:33.327Z"),
			"session_id" : ObjectId("506cfe1b6bb3f7ee5600000e")
		},
		{
			"author" : "rp",
			"cid" : ObjectId("51d1f7f469bedd927d000014"),
			"email" : "rp202@yahoo.com",
			"flags" : [ ],
			"ip" : "38.96.165.241",
			"rate_down" : 0,
			"rate_up" : 3,
			"raters" : DBRef("blog.comments.raters", ObjectId("51d1f7f469bedd927d000013")),
			"replies" : [
				{
					"cid" : ObjectId("51d1fca1eab8ea8b1d000020"),
					"author" : "Oh boy",
					"email" : "zu.d.nim@gmail.com",
					"flags" : [ ],
					"ip" : "100.0.54.183",
					"rate_down" : 0,
					"rate_up" : 3,
					"raters" : DBRef("blog.comments.raters", ObjectId("51d1fca1eab8ea8b1d00001f")),
					"reply" : ObjectId("51d1f7f469bedd927d000014"),
					"reply_author" : "rp",
					"text" : "Nobody can, because it's not. Vine is pointless. There was a recent article about the best 77 Vines and they were awful in every respect.",
					"ts" : ISODate("2013-07-01T22:03:13.248Z"),
					"session_id" : ObjectId("51b7fb7a69beddbe1f000000")
				}
			],
			"session_id" : ObjectId("51d1f2c769bedd1f7300000d"),
			"text" : "Can someone explain why the Vine -- which looks like an animated gif (maybe it is) is better than just shooting a normal 30 second video of the event?",
			"ts" : ISODate("2013-07-01T21:43:16.755Z")
		}
	],
...
},
{
	...
	"comments" : [
		{
			"cid" : ObjectId("51cfc931eab8ea841800003b"),
			"author" : "geomark",
			"email" : "mgeorge6@hotmail.com",
			"flags" : [ ],
			"ip" : "101.51.119.172",
			"rate_down" : 0,
			"rate_up" : 10,
			"raters" : DBRef("blog.comments.raters", ObjectId("51cfc931eab8ea841800003a")),
			"text" : "So that's how they can say they didn't give direct access to the NSA - they give direct access to the FBI who then sends it on to the NSA. As if...",
			"ts" : ISODate("2013-06-30T05:59:13.589Z"),
			"url" : "http://geomark.wordpress.com/",
			"user_id" : ObjectId("5144796469beddba2d000003"),
			"session_id" : ObjectId("5144796469beddba2d000003")
		},
		{
			"cid" : ObjectId("51d048c1eab8ea8c30000016"),
			"author" : "ifthethunderdontgetya™³²®©",
			"email" : "ifthethunderdontgetya@yahoo.com",
			"flags" : [ ],
			"ip" : "68.250.187.41",
			"rate_down" : 0,
			"rate_up" : 0,
			"raters" : DBRef("blog.comments.raters", ObjectId("51d048c1eab8ea8c30000015")),
			"text" : "\"The first slide shows the targeting process of an NSA analyst, with supervisor and FBI OVERSIGHT to ensure that American citizens are not being targeted.\"\n\nYou keep using that word. I do not think it means what you think it means. Here, Paul, try someone who knows what they're talking about.\n\n=>Among other things, the slides highlight the large discrepancies between the way the program is described and the strenuous denials from tech giants such as Google, Yahoo, Microsoft and Facebook about their participation in such a program.",
			"ts" : ISODate("2013-06-30T15:03:29.528Z"),
			"session_id" : ObjectId("51d0477e69bedd385100000a")
		},
		{
			"cid" : ObjectId("51d2660d6bb3f7a00d000020"),
			"author" : "sam.wheeler.94617",
			"email" : "goldeyesstarsunder@yahoo.com",
			"flags" : [ ],
			"ip" : "76.182.93.9",
			"rate_down" : 0,
			"rate_up" : 0,
			"raters" : DBRef("blog.comments.raters", ObjectId("51d2660d6bb3f7a00d00001f")),
			"text" : "\"All the companies named have strongly denied any involvement and James Clapper, the Director of National Intelligence, has stressed that the program is lawful.\"\n\nWhat they fail to mention is that 'lawful' doesn't always equate to 'moral' or 'right'.",
			"ts" : ISODate("2013-07-02T05:33:01.086Z"),
			"user_id" : ObjectId("51d265be69bedd1828000028"),
			"session_id" : ObjectId("51d265be69bedd1828000028"),
			"fb_uid" : "772795674"
		}
	],
